...
/**
 * LkBuilder is used to configure and build an instance of the SDK.
 * 
 * @package lk\api
 */
class LkBuilder
{
     ...
     * @return LkBuilder
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): LkBuilder
    {
     ...
     * @return LkBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): LkBuilder
    {
     ...
     * @return LkBuilder
     */
    public function setServerIndex(int $serverIdx): LkBuilder
    {
